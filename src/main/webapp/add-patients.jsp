...
<body>
    <%
        ...
        Paciente p = new Paciente(nombre, apellido, dni, fechaNac, nSeg);
        if(pacientes.create(p)==1){
            response.sendRedirect("home.jsp");
        }else{
            response.sendRedirect("home.jsp?error=No ha sido posible añadir la inforamción");
        }
    %>
